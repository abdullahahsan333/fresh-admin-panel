        ...
        if (!profileDropdown) {
            ...
            profileDropdown.innerHTML = `
                ...
                <nav class="p-2 text-sm">
                    ...
                    <a href="/admin/assets/archive" class="flex items-center gap-2 px-2 py-2 rounded hover:bg-gray-50">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-600" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7h16M4 12h16M4 17h16"/></svg>
