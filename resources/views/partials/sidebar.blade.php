<aside id="adminSidebar" class="w-60 relative overflow-hidden bg-white border-r border-gray-200 hidden lg:block min-h-screen flex flex-col">
    ...
    <nav class="px-2 space-y-1 mb-7">
        ...
        @php $usersExpanded = isset($activeMenu) && $activeMenu === 'users'; @endphp
        <div class="{{ $usersExpanded ? 'open' : '' }}" data-menu>
            <a href="javascript:void(0);" data-submenu-toggle class="flex items-center gap-2 px-3 h-9 my-1 rounded-md {{ $usersExpanded ? 'text-[rgb(var(--color-primary))] bg-[rgb(var(--color-primary)/.06)]' : 'text-gray-700 hover:bg-gray-50' }}" aria-expanded="{{ $usersExpanded ? 'true' : 'false' }}">
            ...
            <div class="{{ $usersExpanded ? 'pl-4 open' : 'hidden pl-4 close' }}" data-submenu>
                <a href="{{ route('admin.users.index') }}" class="flex items-center gap-2 px-3 h-9 my-1 rounded-md {{ (isset($subMenu) && $subMenu === 'users_index') ? 'text-[rgb(var(--color-primary))] bg-[rgb(var(--color-primary)/.06)]' : 'text-gray-700 hover:bg-gray-50' }}">
                ...
                <a href="{{ route('admin.users.create') }}" class="flex items-center gap-2 px-3 h-9 my-1 rounded-md text-gray-700 hover:bg-gray-50 {{ (isset($subMenu) && $subMenu === 'users_create') ? 'text-[rgb(var(--color-primary))] bg-[rgb(var(--color-primary)/.06)]' : 'text-gray-700 hover:bg-gray-50' }}">
