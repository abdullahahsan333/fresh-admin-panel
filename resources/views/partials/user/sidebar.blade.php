<aside id="userSidebar" class="relative overflow-hidden bg-white border-r border-gray-200 hidden lg:block min-h-screen w-60 flex flex-col">
    <div class="px-3 py-3 flex items-center">
        ...
        @endif
        <span id="userBrandText" class="font-semibold sidebar-text">{{ $site->site_name ?? 'User' }}</span>
