    ...
    <div class="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6 mt-6">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="mt-4 flex gap-3">
                <input id="assetInput" type="text" name="ip" class="flex-1 border rounded-lg px-3 h-10" placeholder="Add IP">
  ...
  ip: "128.199.73.128"</code></pre>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mt-6">
        ...
        <div class="mt-3 flex gap-3">
            <input id="hostnameInput" name="hostname" type="text" 
                class="flex-1 border border-gray-300 rounded-lg px-3 h-10 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[rgb(var(--color-primary))]" 
                placeholder="Add hostname (e.g. db.example.com)">
            <button id="addHostnameBtn" type="button" class="btn btn-primary h-10 px-4">Add</button>
        </div>
        <div class="rounded-lg border border-[rgb(var(--color-primary))] bg-[rgb(var(--color-primary)/.06)] p-3 flex items-center gap-3 mt-2">
            <span class="h-2.5 w-2.5 rounded-full bg-[rgb(var(--color-primary))]"></span>
            <div class="text-sm">
                <div class="font-medium">https://demos.themeselection.com/</div>
