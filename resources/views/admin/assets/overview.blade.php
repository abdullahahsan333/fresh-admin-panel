                        ...
                        <table class="w-full text-left text-sm text-gray-600">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr>
                                    ...
                                    <td class="px-3 py-3">{{ $server->project->name ?? 'Project' }}</td>
                    ...
                    <div class="flex-1 flex flex-col items-center justify-center">
                         ...
                         <div class="relative h-40 w-40 mb-6">
                             <svg class="h-full w-full transform -rotate-90" viewBox="0 0 36 36">
                                 ...
                                 <!-- Progress Circle (62%) -->
                                 <path class="text-purple-500" stroke-dasharray="62, 100" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" stroke-width="3" />
                             </svg>
                         ...
                         <div class="flex items-center gap-8 w-full px-4">
                             <div class="flex items-start gap-2">
                                 <div class="w-3 h-3 rounded bg-purple-100 mt-1"></div>
                                 <div>
