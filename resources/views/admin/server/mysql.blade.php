...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
            ...
            <div class="mt-10 mb-6 relative h-32 w-32 flex items-center justify-center">
                <!-- Circular progress placeholder -->
                <div class="text-sm font-medium text-gray-600">--% Connection Usage</div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <div class="mb-4 flex h-8 w-full rounded overflow-hidden">
                <div class="bg-purple-600 text-white text-xs flex items-center justify-center font-bold" style="width: 70%">SELECT 100.0%</div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 relative flex flex-col items-center justify-center text-center">
            ...
            <div class="mt-8 mb-4">
                 <div class="text-sm font-medium text-gray-600 mb-2">0% Cache Usage</div>
            </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 relative flex flex-col items-center justify-center text-center">
            ...
            <div class="mt-8 mb-4">
                 <div class="text-sm font-medium text-gray-600 mb-2">0% Usage</div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 lg:col-span-2">
            ...
            <div class="flex border-b border-gray-200 mb-4">
                <button class="px-4 py-2 text-purple-600 border-b-2 border-purple-600 font-medium text-sm">Slow Queries</button>
                <button class="px-4 py-2 text-gray-500 hover:text-gray-700 font-medium text-sm">Warns</button>
                <button class="px-4 py-2 text-gray-500 hover:text-gray-700 font-medium text-sm">Errors</button>
            </div>
        ...
        <div class="lg:col-span-1 space-y-6">
            <!-- Bytes Sent -->
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                <h3 class="text-gray-700 font-medium mb-4">Bytes Sent / Sec</h3>
                <div class="text-center py-4">
                    <div class="text-gray-500 mb-1">Bytes Sent</div>
            ...
            <!-- Bytes Received -->
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                <h3 class="text-gray-700 font-medium mb-4">Bytes Received / Sec</h3>
                <div class="text-center py-4">
                    <div class="text-gray-500 mb-1">Bytes Received</div>
                    <!-- <div class="text-xl font-semibold">--</div> -->
                </div>
            </div>
        </div>
