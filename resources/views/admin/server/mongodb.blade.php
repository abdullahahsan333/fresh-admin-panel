        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 flex flex-col">
            ...
            <div class="flex-1 flex flex-col items-center justify-center">
                <div class="mb-4 text-center">
                    ...
                    <span class="text-sm text-gray-500 block">Connection Usage</span>
                </div>
    ...
    <div class="grid grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <div class="flex gap-1 mb-4">
                <span class="px-2 py-1 text-xs font-bold text-white bg-purple-500 rounded-sm">QUERY</span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="grid grid-cols-1 grid-rows-2 gap-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <div class="text-right">
                    <span class="text-sm text-gray-500">Bytes Received</span>
                </div>
            </div>
        </div>
    </div>
