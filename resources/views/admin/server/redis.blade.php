...
<script>
    ...
    const redisOpsOptions = {
        series: [{ name: 'Ops/Sec', data: [45, 56, 75, 115, 85, 95] }],
    ...
    const redisCommandsMemoryOptions = {
        series: [{
            name: 'Commands',
            data: [43, 56, 75, 115]
        }],
        ...
        colors: [themeColor],
        dataLabels: { enabled: false },
        title: { text: 'Commands Vs Memory', align: 'left' },
        xaxis: { categories: ['GET', 'SET', 'HGET', 'HSET'] }
    };

    const redisCacheHitRatioOptions = {
        series: [67],
        chart: {
            height: 150,
            type: 'radialBar',
    ...
    const redisNetworkTrafficOptions = {
        series: [{
            name: 'Input',
            data: [43, 56, 75, 115]
        }, {
        ...
        chart: { height: 300, type: 'line', zoom: { enabled: false } },
        colors: [themeColor, '#007bff'],
        dataLabels: { enabled: false },
        stroke: { curve: 'smooth' },
        title: { text: 'Network Traffic', align: 'left' },
        grid: { row: { colors: ['#f3f3f3', 'transparent'], opacity: 0.5 } },
        xaxis: { categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'] }
    };

    mountChart('#redisOpsPerSecond', redisOpsOptions);
    mountChart('#redisMemoryUsage', redisMemoryOptions);
    mountChart('#redisCommandsMemory', redisCommandsMemoryOptions);
    mountChart('#redisCacheHitRatio', redisCacheHitRatioOptions);
    mountChart('#redisNetworkTraffic', redisNetworkTrafficOptions);
</script>
@endpush
