        ...
        <div class="p-6 overflow-y-auto flex-1 bg-gray-50/50">
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative bg-black border border-gray-200 rounded p-4 text-sm font-mono text-gray-600 h-32 shadow-sm">
                        <button type="button" class="absolute top-2 right-2 inline-flex items-center justify-center h-7 px-2 rounded-lg bg-[rgb(var(--color-primary))] text-white text-xs" title="Copy" aria-label="icon" data-copy-target="#apiRequestBody">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
                        </button>
                        <code id="apiRequestBody" class="block whitespace-pre-wrap">{
"user_id": 1005624,
"member_id": 1034643
}
                        </code>
