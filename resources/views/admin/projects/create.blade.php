...
<div class="max-w-md mx-auto">
    <div class="bg-white shadow rounded-xl px-8 py-3">
        <div class="flex items-center justify-center gap-2 mb-4">
            <span class="inline-block text-3xl text-[rgb(var(--color-primary))]">
        ...
        <form class="mt-4" method="POST" action="{{ route('admin.projects.store') }}">
            ...
            <input type="text" name="name" class="w-full border rounded px-3 py-2 mb-4" placeholder="Enter your project name" required>
            <label class="block text-sm mb-1">Description</label>
            <textarea name="description" class="w-full border rounded px-3 py-2 mb-4" rows="3" placeholder="Enter project description"></textarea>
